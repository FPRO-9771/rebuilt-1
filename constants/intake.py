...
CON_INTAKE = {
    ...
    "down_position": -4.28,     # measured on robot -- arm settles here with brake voltage (re-measure with 1:15 gearbox)
    ...
    "up_transition_fraction": 0.1,     # TUNE on robot (higher = switch to ease sooner)
    ...
    "up_ease_voltage": -0.1,            # TUNE on robot (negative = brakes against momentum)
