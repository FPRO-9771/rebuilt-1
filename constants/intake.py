...
CON_INTAKE = {
    ...
    "down_position": -5.14,     # measured on robot -- arm settles here with brake voltage (re-measure with 1:15 gearbox)
    "position_tolerance": 0.1, # "Close enough" tolerance (rotations)
    ...
    "up_transition_fraction": 0.4,     # TUNE on robot (higher = switch to ease sooner)
    ...
    "up_fight_voltage": 2,            # TUNE on robot (positive = toward up position)
