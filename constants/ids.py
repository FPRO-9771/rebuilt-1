...
MOTOR_IDS = {
    ...
    # Mechanisms
    "conveyor": {"can_id": 20, "type": "talon_fx", "bus": "rio", "wired": False,
                 "current_limit": {"stator": 30, "supply": 15}}, #was 60/40
    "h_feed":   {"can_id": 22, "type": "talon_fx", "bus": "rio", "wired": True,
                 "current_limit": {"stator": 60, "supply": 40}}, #was 60/40
    "v_feed":   {"can_id": 23, "type": "talon_fx", "bus": "rio", "wired": True,
                 "current_limit": {"stator": 60, "supply": 40}},#was 60/40

    # Intake
    "intake_spinner": {"can_id": 40, "type": "talon_fx", "bus": "rio", "wired": True,
                       "current_limit": {"stator": 60, "supply": 40}},#was 60/40
    "intake_left":    {"can_id": 41, "type": "talon_fx", "bus": "rio", "wired": True,
                       "current_limit": {"stator": 60, "supply": 40}},#was 60/40
    "intake_right":   {"can_id": 42, "type": "talon_fx", "bus": "rio", "wired": True,
                       "current_limit": {"stator": 60, "supply": 40}},#was 60/40
    ...
    "hood":     {"can_id": 33, "type": "talon_fxs", "bus": "rio", "wired": False, "sim_rps_per_volt": 1.0,
                 "current_limit": {"stator": 30, "supply": 25}}, #was 30/25
}
