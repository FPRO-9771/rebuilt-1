...
def test_stick_center_gives_center_distance_rps():
    ...
    center_d = TEST_CON_DISTANCE_TABLE["manual_center_distance"]
    expected_rps = get_shooter_settings(center_d)
...
def test_stick_full_forward_gives_max_distance_rps():
    ...
    max_d = TEST_CON_DISTANCE_TABLE["manual_max_distance"]
    expected_rps = get_shooter_settings(max_d)
    assert launcher.motor._velocity == expected_rps
...
def test_stick_full_back_gives_min_distance_rps():
    ...
    min_d = TEST_CON_DISTANCE_TABLE["manual_min_distance"]
    expected_rps = get_shooter_settings(min_d)
    assert launcher.motor._velocity == expected_rps
