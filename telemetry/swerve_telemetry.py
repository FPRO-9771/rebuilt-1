"""
Swerve drivetrain telemetry.
Publishes pose, module states, and chassis speeds to NetworkTables and SignalLogger.
...
class SwerveTelemetry:
    ...
    def telemeterize(self, state: swerve.SwerveDrivetrain.SwerveDriveState):
        ...
        SmartDashboard.putNumber("Drive/Pose Y (m)", round(state.pose.y, 2))
        SmartDashboard.putNumber(
            "Drive/Heading (deg)",
            round(state.pose.rotation().degrees(), 1),
        )
